...
public class FileController {
	...
	private static final String FILE_DIR = "attachFile";
	private static final String PATH = "WEB-INF" + SP + FILE_DIR;
	...
	public NexacroFileResult downloadFile(HttpServletRequest request) throws Exception {
	  ...
	  if(dsFileInfo.getRowCount() > 1) {
	    ...
	    displayFileName = dsFileInfo.getString(0, "displayFileNm");
	    fileName = dsFileInfo.getString(0, "realFileNm");
	...
	private File getCompressZipFile(DataSet fileInfo, String realPath, String compressName, String charsetOfRequest) throws IOException {
	  ...
	  for(int i=0;i<files.length;i++) {
	    files[i] = URLDecoder.decode(fileInfo.getString(i, "realFileNm"), charsetOfRequest);
